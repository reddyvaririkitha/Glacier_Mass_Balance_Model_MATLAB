...
% Here the variation of surface temperature of glacier and runoff for
% different values of albedo is obtained.
...
%Values of albedo, Runoff and Surf_temp for every new albedo
albedo
Runoff
Surf_temp

% Plots of Surface temperature and Runoff vs Albedo
scatter(albedo,Runoff,'r','filled');
title('Sensitivity Analysis of glacier - Runoff vs Albedo')
xlabel('Albedo')
ylabel('Runoff (mm.w.e)')

scatter(albedo,Surf_temp,'c','filled');
title('Sensitivity Analysis of glacier - Surface Temperature vs Albedo')
xlabel('Albedo')
ylabel('Surface Temperature (degree Celcius)')
